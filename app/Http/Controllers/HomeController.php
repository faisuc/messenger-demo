...
class HomeController extends Controller
{
    ...
    {
        $users = User::query()->oldest()->whereNotIn('email', ['richard.tippin@gmail.com', 'ajnozari@gmail.com', 'yogimon@gmail.com'])->limit(10)->get()->shuffle()->reject(function ($user){
            return Cache::has(strtolower(class_basename($user)).'_online_'.$user->id) || Cache::has(strtolower(class_basename($user)).'_away_'.$user->id);
        });
    ...
    public function contactSend()
    {
        ...
        Mail::to("your.email@gmail.com")->send(new ContactUs($data));
