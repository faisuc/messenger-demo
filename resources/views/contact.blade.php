                                ...
                                <form class="needs-validation" id="contact_us" action="javascript:TippinManager.forms().ContactUs();" novalidate>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="your_name" autocomplete="name" placeholder="Your Name" minlength="3" name="your_name" required value="{{$user ? $user->name : ""}}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="your_email">Your Email</label>
                                            <input type="email" class="form-control" id="your_email" placeholder="Your Email" name="your_email" required value="{{$user ? $user->email : ""}}">
                                        </div>
                                    </div>
